 ...
 */
function walkDoc(startDoc, 
/** Return something falsy to prevent walking of child docs */
debug, callback, parents = [], index = undefined) {
    if (!startDoc) {
        return true;
    }
    if (debug) {
    ...
    if (typeof startDoc === 'string') {
        ...
        startDoc.every((innerDoc, index) => {
            return walkDoc(innerDoc, debug, callback, [
        ...
        return walkDoc(startDoc.contents, debug, callback, [
        ...
        return walkDoc(startDoc.parts, debug, callback, [
            { parent: startDoc, childIndexInThisParent: undefined },
            ...parents,
        ], undefined);
    }
